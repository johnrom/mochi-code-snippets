...
type pageCUsersjohnDocumentsprojectsjsremarkCodeImportSnippetspackagescodeSnippetsWebsitesrcpagesMarkdownRemarkFrontmatterSlugTsx4041915688QueryVariables = Exact<{
  id: Scalars['String'];
}>;


type pageCUsersjohnDocumentsprojectsjsremarkCodeImportSnippetspackagescodeSnippetsWebsitesrcpagesMarkdownRemarkFrontmatterSlugTsx4041915688Query = { readonly markdownRemark: Maybe<(
    Pick<MarkdownRemark, 'html'>
    & { readonly frontmatter: Maybe<Pick<MarkdownRemarkFrontmatter, 'slug'>> }
  )> };
